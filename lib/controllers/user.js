...
function getSearchUsers(req, res) {
    ...
    let nonAuthUserSelect = [User.userId, User.username, User.firstName, User.lastName, User.dateCreated];

    let authUserSelect = [User.userId, User.username, User.firstName, User.lastName, User.emailAddress, User.dateCreated];

    let userFieldsSelect = (req.query.username === req.user.username || req.query.emailAddress === req.user.emailAddress) ? authUserSelect : nonAuthUserSelect;
