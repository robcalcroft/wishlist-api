        ...
        (err, result) => {
            ...
            db.query(
                ...
                (err, result) => {
                    ...
                    let clientUserPromise = new Promise((resolve, reject) => {
                        db.query(
                            ClientUser
                                .select(
                                    ClientUser.count()
                                ...
                                .where(
                                    ClientUser.clientId.equals(authCode.clientId)
                                )
                                .and(
                                    ClientUser.userId.equals(authCode.userId)
                                )
                                .toQuery(),
                            (err, result) => {
                                if(err) {
                    ...
                    Promise.all([accessTokenPromise, refreshTokenPromise, clientUserPromise]).then(() => {
