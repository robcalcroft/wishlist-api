...
Wishlist.meta = require(`${Wishlist.appRoot}/package.json`);
...
Wishlist.app.set("version", Wishlist.meta.version);
Wishlist.app.set("description", Wishlist.meta.description);
Wishlist.app.set("author", Wishlist.meta.author);
