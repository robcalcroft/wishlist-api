 ...
 * @apiDescription Gives metadata about each wishlist from the search. If the user id searched for
 * is not the currently authenticated user, only publically viewable wishlists will be shown.
 * @apiGroup Wishlist
 * @apiVersion 1.0.0
 *
 ...
 * @apiParam {String} [is_default] Set the wishlist as the default wishlist for the user A header
 * image for the list
...
/**
 * @api {put} /wishlist Update a wishlist
 *
 * @apiDescription Update a wishlist with new data
 * @apiGroup Wishlist
 * @apiVersion 1.0.0
 *
 * @apiPermission Bearer Token
 ...
 *
 * @apiParam {String} wishlist_id The wishlist ID to search upon
 * @apiParam {Int} [price_low] Price filtering between values - mandatory if companion option is
 * specified.
 * @apiParam {Int} [price_high] Price filtering between values - mandatory if companion option is
 * specified.
 * @apiParam {Int=1,2,3,4,5} [priority] Filter the priority of results. Multiples can be specified
 * by a comma: priority=5,4
 * @apiParam {String='desc','asc'} [order] The order of the results
 *
 * @apiSuccessExample {json} Success - results
 *     {
 ...
 * @apiDescription Provide an entry to a specified wishlist (you can use /api/<version>/uri-metadata
 * to get most of the required data below)
 * @apiGroup Wishlist
 * @apiVersion 1.0.0
 *
 * @apiPermission Bearer Token
 ...
 * @apiParam {String} [price_currency_symbol] The symbol of the specified currency - required if
 * price is specified
...
/**
 * @api {put} /wishlist/item Update an entry to a wishlist
 * @apiDescription Update an entry to a wishlist, to fix bad info
 * @apiGroup Wishlist
 * @apiVersion 1.0.0
 *
 * @apiPermission Bearer Token
