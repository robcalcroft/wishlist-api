...
import { getSearchUsers, getAuthenticatedUser, getAuthorisedApps } from '../controllers/user';
...
/**
 * @api {get} /user/authorised-apps Lists authorised apps
 *
 * @apiDescription Retrieve an application name that is authorised to access the account and a
 * timestamp that tells the user when it was authorised.
 * @apiGroup User
 * @apiVersion 1.0.0
 *
 * @apiPermission Bearer Token
